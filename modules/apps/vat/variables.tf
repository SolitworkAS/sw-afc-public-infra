...
variable "vat_version" {
  description = "version of VAT to deploy, must be a semantic verion"
}
...
variable "rabbitmq_name" {
  description = "name of the rabbitmq instance, must only contain lowercase letters, numbers and dashes"
}
...
variable "storage_primary_access_key_vat" {
