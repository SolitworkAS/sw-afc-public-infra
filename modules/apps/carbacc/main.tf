locals {
  ...
  carbacc_sourceload_service_image = "${var.container_registry}/images/esg/sourceload_service:${var.carbacc_version}"

  # Carbacc taskmanagement configuration
  carbacc_taskmanagement_service_name  = "carbacc-taskmanagement-service"
  carbacc_taskmanagement_service_image = "${var.container_registry}/images/esg/taskmanagement_service:${var.carbacc_version}"
  attachments_mount_path_carbacc       = "/carbacc/files"
            ...
            volumeMounts = [
              {
                ...
                mountPath  = local.attachments_mount_path_carbacc
              }
            ]
          }
        ]
